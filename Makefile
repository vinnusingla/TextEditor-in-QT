...
# Generated by qmake (2.01a) (Qt 4.8.7) on: Fri Jan 5 23:53:01 2018
# Project:  Editor.pro
# Template: app
...
INCPATH       = -I/usr/local/qt4/mkspecs/linux-g++ -I. -I/usr/local/qt4/include/QtCore -I/usr/local/qt4/include/QtGui -I/usr/local/qt4/include -I. -I.
LINK          = g++
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Editor1.0.0/ && $(COPY_FILE) --parents editor.h .tmp/Editor1.0.0/ && $(COPY_FILE) --parents editor.cpp main.cpp .tmp/Editor1.0.0/ && (cd `dirname .tmp/Editor1.0.0` && $(TAR) Editor1.0.0.tar Editor1.0.0 && $(COMPRESS) Editor1.0.0.tar) && $(MOVE) `dirname .tmp/Editor1.0.0`/Editor1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Editor1.0.0
