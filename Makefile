...
# Generated by qmake (2.01a) (Qt 4.8.7) on: Sat Jan 6 12:10:13 2018
# Project:  Editor.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Editor1.0.0/ && $(COPY_FILE) --parents editor.h Library/library.cpp .tmp/Editor1.0.0/ && $(COPY_FILE) --parents editor.cpp main.cpp .tmp/Editor1.0.0/ && (cd `dirname .tmp/Editor1.0.0` && $(TAR) Editor1.0.0.tar Editor1.0.0 && $(COMPRESS) Editor1.0.0.tar) && $(MOVE) `dirname .tmp/Editor1.0.0`/Editor1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Editor1.0.0
...
editor.o: editor.cpp Library/library.cpp \
		editor.h
